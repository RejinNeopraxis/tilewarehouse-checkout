...
class Checkout extends Component<
    CheckoutProps & WithCheckoutProps & WithLanguageProps & AnalyticsContextProps & CustomGlobalStateStore,
    CheckoutState
> {
    state: CheckoutState = {
    ...
    render(): ReactNode {
        ...
        return (
            <div className={classNames({ 'is-embedded': isEmbedded() })}>
                <div className="layout optimizedCheckout-contentPrimary layout-checkout">
                    {this.renderContent()}
                </div>
                {errorModal}
            </div>
        ...
        return (
            <LoadingOverlay hideContentWhenLoading isLoading={isRedirecting}>
                <div className="layout-main">
                    ...
                    { cart && customGlobalState?.hasPerformedInitialFetch ? (
                        <React.Fragment>
                ...
                { this.props.customGlobalState?.hasPerformedInitialFetch ? this.renderCartSummary() : null }
            </LoadingOverlay>
        );
    }
...
export default withAnalytics(withLanguage(withCheckout(mapToCheckoutProps)(
    withCustomGlobalState(Checkout, (state) => ({
        hasPerformedInitialFetch: state.hasPerformedInitialFetch,
    }))
)));
