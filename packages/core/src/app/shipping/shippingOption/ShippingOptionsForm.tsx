...
> {
    ...
    private selectDefaultShippingOptions: (state: CheckoutSelectors) => void = async () => {
        // We don't want a default delivery method selected here, the date needs to be validated
        // first so rely on ShippingDatePicker to provide the default method.
        return;
    };
