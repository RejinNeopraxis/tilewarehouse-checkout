...
class Shipping extends Component<ShippingProps & WithCheckoutShippingProps & CustomGlobalStateStore, ShippingState> {
    constructor(props: ShippingProps & WithCheckoutShippingProps & CustomGlobalStateStore) {
        super(props);
    ...
    private handleSingleShippingSubmit: (values: SingleShippingFormValues) => void = async ({
        ...
        if (customGlobalState?.comments || customGlobalState?.selectedDeliveryDate) {
            const formattedComment = formatComments(customGlobalState.comments, customGlobalState.selectedDeliveryDate, customGlobalState.narrowRoad);

            promises.push(updateCheckout({ customerMessage: formattedComment }));
        }
...
export default withCheckout(mapToShippingProps)(
    withCustomGlobalState(Shipping, (state) => ({
        selectedDeliveryDate: state.selectedDeliveryDate,
        comments: state.comments,
        narrowRoad: state.narrowRoad,
    }))
);
