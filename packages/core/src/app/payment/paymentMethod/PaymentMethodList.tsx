    ...
    return (
        ...
        >
            {methods.map((method) => {
                ...
                const showOnlyWhenCheckoutLimitHasReached = get(method, 'id', false);

                // Defaults grand total to 0 at the possibility it's undefined
                const total = cartTotal ?? 0;

                if ((showOnlyWhenCheckoutLimitHasReached === 'klarna_account' || showOnlyWhenCheckoutLimitHasReached === 'klarna-pay_later') && total < 20) {
                    return;
                }
